...
import metric_driverlog as metric
...
def main():    
    ...
    for folder in os.listdir(dataset_dir):   
        ...
        for conversion in metric.convert_action_domain[domain].keys():         
            state = state.replace(conversion, metric.convert_action_domain[domain][conversion])
            
        vettore_p = metric.estrai_p(state)
        ...
        metric.convert_action_domain1["driverlog"] = convert_action_dr1   
